...
const web3 = new Web3(new Web3.providers.WebsocketProvider('ws://192.168.43.176:8545'))
...
const exchangeContract = new web3.eth.Contract(Swap.abi, EXCHANGE_ADDRESS, {
    from: '0xaDCbd8201C7a59DCE59863B6316443c087325966', // default from address
...
async function hello(){
    // let symbol1 = await exchangeContract.methods.getCoinSymbol(1).call(); ///teste para saber o nome da moeda
    let symbol1 = web3.utils.fromWei(await exchangeContract.methods.priceCoinAt(1,0).call()); //preco da moeda conrrelacao a outra
    // let symbol1 = web3.utils.fromWei(await exchangeContract.methods.getRate(1,0).call()); //rate da moeda
    console.log(web3.currentProvider.connected, 'Hello!W', symbol1);
}
